'''This script clears calibration flags. By default, it assumes that there's only one device
...
dev.del_conf("calibration", "touch_ok")
dev.del_conf("calibration", "pots_ok")
dev.set_boot_mode()
